...
def load():
    if is_answer:
        from lab12.ch012_t09_you_win_ans import ship_row, ship_col, guess_row, guess_col
    else:
        from lab12.ch012_t09_you_win import ship_row, ship_col, guess_row, guess_col
