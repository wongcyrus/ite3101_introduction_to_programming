...
class TestOutput(unittest.TestCase):
    ...
    def load(self):
        sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '..\lab')))
        self.myModule = __import__('lab12.ch012_t11_bad_aim' + "_ans" if is_answer else "", globals(), locals(), [''],
                                   0)
